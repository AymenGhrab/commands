...
public class UniversiteController {
    ...
    public Universite affecterUniversite(@PathVariable ("universite-nom")String nomUniversite,@PathVariable("foyer-id")Long idFoyer)  {

        return universiteServices.affecterFoyerUniversite(idFoyer,nomUniversite);
    }
    @PutMapping("/desaffecterFoyer/{universite-nom}/{foyer-id}")
    public Universite desaffecterUniversite(@PathVariable ("universite-nom")String nomUniversite)  {

        return universiteServices.DesaffecterFoyerUniversite(nomUniversite)  ;
    }
}
